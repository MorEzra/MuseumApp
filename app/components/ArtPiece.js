...
export let artPieces =
  [ new ArtPiece("פרדריקה מריה בר של קילמט", ["יצירה מאירופה של ראשית המאה ה-20", "יצירה פוביסטית", "אמן הולנדי"],                   0,   require("../assets/images/klimt_1.png")),
    ...
    new ArtPiece("סירה בנמל אנטוורפן מאת ז'ורז' בראק", ["ציור אקספרסיוניסטי", "ציור מופשט", "אמנות שנוצרה אחרי מלחמת העולם השניה"], 2,   require("../assets/images/braque_3.png")),
    new ArtPiece("תולעי אדמה מאת ג'קסון פולוק", ["אמן שוויצרי", "אמן רב תחומי", "אמן שפעל בפריז"],                                     0,  require("../assets/images/pollock_4.png")),
