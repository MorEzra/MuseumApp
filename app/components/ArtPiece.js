...
export let artPieces =
  [ new ArtPiece(1, "פרדריקה מריה בר מאת קילמט", ["יצירה מאירופה של ראשית המאה ה-20", "יצירה פוביסטית", "אמן הולנדי"],                   0,   require("../assets/images/pieces/1.png"),         require("../assets/images/maps/1.jpg"), "",	require('../assets/audio/pieces_explanations/1.wav')),
    ...
    new ArtPiece(5, "אישה ונציאנית IX מאת אלברטו גי'אקומטי", ["ציור המתייחס לאמנות הפיסול", "אמנות סוריאליסטית", "אמן יווני"],          0,  require("../assets/images/pieces/5.png"),           require("../assets/images/maps/5.jpg"), "היצירה הבאה היא ממש מאחוריכם בשעה 6. הסתובבו אחורה. ", require('../assets/audio/pieces_explanations/5.wav')),
    new ArtPiece(6, "סוסים עתיקים מאת ג'ורגו'ו דה קיריקו", ["אמנות מזרם הדאדא", "אמן ישראלי", "אמנות מוגדרת"],                           0,  require("../assets/images/pieces/6.png"),           require("../assets/images/maps/6.jpg"), "היצירה הבאה היא בשעה 1 שלכם. פנו ימינה והיא באולם ליד.", require('../assets/audio/pieces_explanations/6.wav')),
    ...
    new ArtPiece(8, "דיוקן אישה מאת פבלו פיקסו", ["אמן שוויצרי", "אמן רב תחומי", "אמן שפעל בפריז"],                                        0,   require("../assets/images/pieces/8.png"),         require("../assets/images/maps/8.jpg"), "היצירה הבאה היא בשעה 1 שלכם בחדר ליד.", require('../assets/audio/pieces_explanations/8.wav'))
  ]
