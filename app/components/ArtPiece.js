...
export let artPieces =
  [ new ArtPiece(1, "פרדריקה מריה בר מאת קלימט", ["יצירה מאירופה של ראשית המאה ה-20", "יצירה פוביסטית", "אמן הולנדי"],                  0,   require("../assets/images/pieces/1.png"),         require("../assets/images/maps/1.jpg"), "",	require('../assets/audio/pieces_explanations/1.wav'),                                                                             ["Art piece from beggining of 20th century",       "phobistic art piece",      "dutch artist"]),
    ...
    new ArtPiece(3, "סירה בנמל אנטוורפן מאת ז'ורז' בראק", ["ציור אקספרסיוניסטי", "ציור מופשט", "אמנות שנוצרה אחרי מלחמת העולם השניה"], 2,   require("../assets/images/pieces/3.png"),          require("../assets/images/maps/3.jpg"), "היצירה היא בשעה 1 שלכם. פנו ימינה המשיכו ישר ופנו שוב ימינה", require('../assets/audio/pieces_explanations/3.wav'),              ["Expressionist painting",                         "Abstract painting",        "Art created in 2nd world war"]),             
