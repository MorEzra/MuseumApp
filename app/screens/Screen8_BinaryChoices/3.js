...
export let tBeginBinaryChoicesV1Q3  = -1;
export let tFinishBinaryChoicesV1Q3 = -1;

export let rate3;

export default function BinaryChoices1_3({navigation}) {    
  let tBeginTimer = new Date();
  tBeginBinaryChoicesV1Q3 = tBeginTimer.getHours() + ":" + tBeginTimer.getMinutes() + ":" + tBeginTimer.getSeconds() + ":" + tBeginTimer.getMilliseconds();
    ...
    <View style={globalStyles.container}>
      ...
      <Button 
          ...
          onPress={() => {    
            ...
            tFinishBinaryChoicesV1Q3 = finishTimer.getHours() + ":" + finishTimer.getMinutes() + ":" + finishTimer.getSeconds() + ":" + finishTimer.getMilliseconds();
