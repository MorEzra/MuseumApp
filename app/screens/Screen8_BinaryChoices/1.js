...
export let tBeginBinaryChoicesV1Q1  = -1;
export let tFinishBinaryChoicesV1Q1 = -1;
export let rate1 = 4;
      ...
      <View style={globalStyles.buttonView}>
        <TouchableOpacity 
            onPress={() => {         
              ...
              tFinishBinaryChoicesV1Q1 = finishTimer.getHours() + ":" + finishTimer.getMinutes() + ":" + finishTimer.getSeconds() + ":" + finishTimer.getMilliseconds();
